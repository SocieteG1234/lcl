...
const CardVisual = ({ gradient, labelColor, type, textColor, user, cardNum, accountIndex }) => (
  ...
  >
    ...
    {/* Type vertical droite */}
    <div
      className="absolute right-4 top-1/2 font-black tracking-widest select-none text-xs"
      style={{
    ...
    {/* Contenu carte — disposition exacte LCL */}
    <div className="relative z-10 h-full flex flex-col justify-between">

      {/* HAUT : Puce en haut à gauche, puis Mes dépenses en dessous */}
      <div>
      ...
      {/* MILIEU : Solde du compte correspondant */}
      ...
      {/* BAS : Nom + numéro/date à gauche, CB+VISA à droite */}
...
const CartePage = () => {
  ...
  const CARDS_DEF = [
    {
      id:        'premier',
      label:     'Carte Premier',
      gradient:  'linear-gradient(135deg, #d4b84a 0%, #e8d06a 30%, #c9a227 60%, #b8941f 100%)',
      labelColor:'#1a237e',
      textColor: '#1a237e',
      type:      'PREMIER',
      cardNum:   'XX1289',
    ...
    },
    {
      id:        'black',
      label:     'Carte Black',
      gradient:  'linear-gradient(135deg, #212121 0%, #424242 50%, #1a1a1a 100%)',
      labelColor:'#ffffff',
      textColor: '#ffffff',
      type:      'PREMIER',
      cardNum:   'XX1289',
  ...
  return (
    <div className="min-h-screen font-sans pb-24" style={{ backgroundColor: '#0d1b6e' }}>
            ...
            {CARDS_DEF.map((c, i) => (
              ...
              >
                <CardVisual
                  ...
                  accountIndex={i}
                />
                <p className="text-center text-xs font-semibold mt-2 text-white opacity-80">
                  {c.label}
                </p>
              </button>
            ))}
          ...
          <div className="flex justify-center gap-2 mt-3">
            {CARDS_DEF.map((_, i) => (
              <div
                ...
                style={{
                  width:           activeCard === i ? 16 : 6,
                  height:          6,
                  backgroundColor: activeCard === i ? '#ffffff' : 'rgba(255,255,255,0.3)',
                }}
              />
            ))}
          </div>
      ...
      {/* Zone blanche : SOS + paramètres */}
      <div className="bg-white mx-4 mt-4 rounded-2xl shadow-sm overflow-hidden">
        {/* SOS Carte */}
        <div className="px-6 pt-5 pb-4">
          <button
            className="w-full py-3 rounded-full font-bold text-sm text-white shadow-md active:scale-95 transition-transform"
        ...
        <div className="flex border-b border-gray-200 px-6">
          {['parametres', 'options'].map((tab) => (
            <button
              ...
              style={{
                color:        activeTab === tab ? LCL_BLUE : '#9CA3AF',
                borderBottom: activeTab === tab ? `2px solid ${LCL_BLUE}` : '2px solid transparent',
              }}
            >
            ...
            <>
              ...
              <div className="flex items-center justify-between bg-gray-50 rounded-xl p-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-blue-50 border-2 flex items-center justify-center" style={{ borderColor: LCL_BLUE }}>
      ...
      {/* Texte bas de page - blanc sur fond bleu */}
